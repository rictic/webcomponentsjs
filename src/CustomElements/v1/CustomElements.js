...
(function() {
  ...
  function CustomElementsRegistry() {
    ...
    /** @private {!Map<string, !{promise: !Promise, resolve: !Function}>} */
    ...
    /** @public {boolean} Whether this registry is polyfilled. */
    this.polyfilled = true;
    /** @public {boolean} Set to true to enable the flush() method to work.
     *    This should only be done for tests, as it causes a memory leak.
     */
  ...
  for (var i = 0; i < htmlElementSubclasses.length; i++) {
    var ctor = window[htmlElementSubclasses[i]];
    if (ctor) {
